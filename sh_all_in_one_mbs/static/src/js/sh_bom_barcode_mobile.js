...
/*    $('.o_notification_manager').on('DOMSubtreeModified', function () {
    	  //alert("Span HTML is now " + $(this).html());
        var $notification = $('body .o_notification_manager .o_notification .toast-header .o_notification_title');
        
    	console.log("noti value ==>" + $notification.last().html() );
   });*/
